            ...
            {Object.keys(data).map((item,index) => {
              return (
                <tr className={classes.tbl_row} key={index}>
                  ...
                  <td className={data[item]["7_years_total_return"] > 0 ? classes.success : classes.warning}>{data[item]["7_years_total_return"]}%</td>
                  <td className={data[item]["10_years_total_return"] > 0 ? classes.success : classes.warning}>{data[item]["10_years_total_return"]}%</td>
