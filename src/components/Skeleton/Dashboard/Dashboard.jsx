...
const DashboardSkeleton = () => {
    return (
        <Container>
            ...
            <Wrapper>
                <Skeleton animation="wave" variant="rect" width="70%" height={350}/>
                <Skeleton animation="wave" variant="rect" width="25%" height={350}/>
            </Wrapper>
            ...
            <Wrapper>
                <Skeleton animation="wave" variant="rect" width="31%" height={250}/>
                <Skeleton animation="wave" variant="rect" width="31%" height={250}/>
                <Skeleton animation="wave" variant="rect" width="31%" height={250}/>
            </Wrapper>
        </Container>
