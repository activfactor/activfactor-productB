    ...
    render(){
        return(
            <div className={classes.container}>
                ...
                <Input type="submit" value="Connect Brokerage" onClick={this.props.ConnectBrokerage} />
                <Input type="submit" value="Create an Account" onClick={this.props.CreateAccount} color="black" />
                </div>
            </div>
        );
    }
