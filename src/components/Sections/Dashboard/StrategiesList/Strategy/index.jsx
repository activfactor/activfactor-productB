    ...
    return (
      <div className={`dashboard_strategy-list`}>
        <div className="_strategy-list-item">
          ...
          <Link nameOfClass="btn _btn-list-item" to='/strategy-monitor/details' onClick={() => {this.props.changeStrategyName(this.props.strategyName); this.props.updateLocation('/strategy-monitor')}}>{this.props.strategyName}</Link>
